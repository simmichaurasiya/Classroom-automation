...
def faceDetection(test_img):
    ...
    face_haar_cascade = cv2.CascadeClassifier('C:/Users/Admin/PycharmProjects/FaceRecog/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
...
def markAttendance(name):
    with open('C:/Users/Admin/PycharmProjects/FaceRecog/AttendanceSheet.csv','r+') as f:
